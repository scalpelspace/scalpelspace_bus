...
typedef enum {
  ...
  MC_BRUSHED_CAN_DBC_IDX_DATETIME_SET = 8,
  MC_BRUSHED_CAN_DBC_IDX_DATETIME_GET = 9,
  MC_BRUSHED_CAN_DBC_IDX_DATETIME_GET_RESPONSE = 10,
  MC_BRUSHED_CAN_DBC_IDX_RGB_LED_SET = 11,
